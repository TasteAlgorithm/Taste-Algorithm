...
# 组长负责内容（每人一周，轮流制）
1.每周六23:59前将接下来一周的刷题模块告知大家，方便大家提前预习
2.周日-周四，每天23:59前将隔天的题目选好推送GitHub
3.检查组员提交情况，保证提供的算法，能正常编译
4.整理算法题的思路、关键点解析
5.添加扩展思考点
6.当天晚上10点30之前截止提交，代码不能正常通过和未提交的队员请主动按10元/道发红包到群里，由豪杰保管作为刷题基金。
